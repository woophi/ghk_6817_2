...
export const App = () => {
  ...
  const submit = () => {
    if (loading) return;
    window.gtag('event', 'ios_jackpot_nov_finish_var2');
    setLoading(true);
              ...
              >
                ...
                {numbersData[ticketIndex] && numbersData[ticketIndex].selectedComboIndexes.length ? null : (
                  <ButtonMobile
                    ...
                    onClick={() => {
                      window.gtag('event', 'ios_jackpot_nov_choose_var2');
                      setNumbersData(
                        numbersData.concat([
                          {
                            comboNumbers: get6Rows(),
              ...
              {numbersData[ticketIndex] && (
                ...
                >
                  ...
                  <ButtonMobile
                    ...
                    size={40}
                    onClick={() => {
                      window.gtag('event', `ios_jackpot_nov_combination_${ticketIndex + 1}_var2`);
                      setNumbersData(
    ...
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', 'ios_jackpot_nov_luck_var2');
            setStep('numbers');
          }}
        >
